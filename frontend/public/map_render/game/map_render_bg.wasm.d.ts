...
export function closure374_externref_shim(a: number, b: number, c: number): void;
export function _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h1ae767c157191c54(a: number, b: number): void;
export function closure2482_externref_shim(a: number, b: number, c: number): void;
export function _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hede8e96dfbb56144(a: number, b: number): void;
export function closure2485_externref_shim(a: number, b: number, c: number, d: number): void;
export function _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hc543f30853afe4a5(a: number, b: number): void;
export function closure71722_externref_shim(a: number, b: number, c: number): void;
