...
export function _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h43cf381058c12a25(a: number, b: number): void;
export function closure81_externref_shim(a: number, b: number, c: number): void;
export function closure2481_externref_shim(a: number, b: number, c: number): void;
export function _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h17b20c9df884a6a6(a: number, b: number): void;
export function closure2486_externref_shim(a: number, b: number, c: number, d: number): void;
export function _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hb4f9a867b9e043de(a: number, b: number): void;
export function closure71738_externref_shim(a: number, b: number, c: number): void;
