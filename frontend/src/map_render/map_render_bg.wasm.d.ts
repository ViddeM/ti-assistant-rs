...
export function wasm_bindgen__convert__closures__invoke0_mut__heb22ff9bb93f0ba3(a: number, b: number): void;
export function wasm_bindgen__convert__closures__invoke2_mut__h52715461ddc5e5cf(a: number, b: number, c: number, d: number): void;
export function wasm_bindgen__convert__closures__invoke1_mut__h4a5f0c7d41664e5e(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke0_mut__heba238a9e043441b(a: number, b: number): void;
export function wasm_bindgen__convert__closures__invoke1_mut__h25de211d5fdba359(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke0_mut__he79279558451b841(a: number, b: number): void;
export function wasm_bindgen__convert__closures__invoke1_mut__h640c9f8c6b50c545(a: number, b: number, c: number): void;
